// lib/rulesEngineMM.ts

import dayjs from "dayjs";
import { supabaseAdmin } from "@/lib/supabaseAdmin";
import { saveMatchmakerControleResultaten } from "@/lib/matchmaker/saveMatchmakerControleResultaten";
import {
...
export async function rulesEngineMM(opts: {
  controle_run_id: string;
  matchmaking_id: string;
  ctxRows: any[];
  ...
  await saveMatchmakerControleResultaten({
    controle_run_id,
    matchmaking_id,
    hits,
