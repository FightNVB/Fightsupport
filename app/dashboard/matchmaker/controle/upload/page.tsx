...
function canUploadMatchmaking(role: unknown) {
...
export default function UploadMatchmakingMatchmakerPage() {
  ...
  const canUpload = useMemo(() => canUploadMatchmaking(profile.role), [profile.role]);
  ...
  async function onUpload() {
    ...
    if (!canUpload) {
      setMelding("Je hebt geen rechten om als matchmaker een matchmaking te uploaden.");
      return;
    }
    ...
    try {
      ...
      setMelding("Upload gelukt. Matchmaking staat nu in controle.");
      router.push("/dashboard/matchmaker/controle/ontvangen");
    } catch (e: any) {
      console.error(e);
  ...
  return (
    <main style={pageBackground}>
      ...
      <TitleBand
        ...
        subtitle="Excel upload naar controle"
        email={user?.email ?? ""}
        actionLabel="Terug"
        actionIcon={<ArrowLeft size={15} strokeWidth={2.8} />}
        onAction={() => router.push("/dashboard/matchmaker/controle/ontvangen")}
      />
        ...
        {!canUpload && (
          <div style={{ marginBottom: 10 }}>
            <SteelFrame>
              ...
              >
                Je hebt geen rechten om als matchmaker een matchmaking te uploaden.
              </div>
            </SteelFrame>
          </div>
        )}
          ...
          <SteelFrame>
            <div className="fs-panel-fill" style={{ ...darkPlate, padding: "12px 14px" }}>
              ...
              <SectionHeader
                ...
                subtitle="Vul de evenementgegevens in en upload daarna direct het bestand naar controle."
              />
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <p style={{ marginTop: 10 }}>
                      Matchmakings uit matchmaking nl kan je hier ook uploaden.
                    </p>
                  </div>
                </div>
  ...
  return (
    <div style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
      ...
      <div style={{ minWidth: 0, flex: 1, paddingTop: 1 }}>
        ...
        <div style={{ marginTop: 7, fontSize: 11.5, color: "#d7d7d7", lineHeight: 1.25 }}>
          {subtitle}
        </div>
      </div>
    </div>
