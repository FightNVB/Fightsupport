...
type TabKey = "controle" | "nvbcontrole";
...
export default function ControleOverzichtPage() {
  ...
  const nvbControleCount = useMemo(
                ...
                <div className="justify-self-start">
                  <div className="leading-tight">
                    ...
                    <div className="mt-1 text-sm text-white/85">
                      Dien matchmakings in voor admin controle, bekijk resultaten en beheer uw eigen uploads
                    </div>
                  </div>
                      ...
                      <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
                        <div>
                          ...
                          <div className="mt-1 text-xs text-zinc-500">
                            {activeTab === "nvbcontrole"
                              ? "Overzicht van uw matchmakings die naar NVB controle zijn gestuurd"
                          ...
                          <tbody>
                            {filteredRows.length === 0 ? (
                              <tr>
                                ...
                                >
                                  {activeTab === "nvbcontrole"
                                    ? "Geen naar NVB controle gestuurde matchmakings gevonden."
                                    ...
                                    <td className="px-4 py-3">
                                      <div className="flex flex-wrap items-center gap-3">
                                        <Link
                                          href={
                                            hasMatchmaking
                                              ? `/dashboard/matchmaker/matchmaking/${r.matchmaking_id}`
                                              : "#"
                                          }
                                          className={[
