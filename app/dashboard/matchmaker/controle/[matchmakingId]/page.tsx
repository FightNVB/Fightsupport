...
export default function ControleMatchmakingPage() {
  ...
  const [overlaySubMessage, setOverlaySubMessage] = useState(
    "Sluit deze pagina niet af totdat de actie klaar is."
  );

  function openOverlay(title: string, message: string, subMessage?: string) {
    setOverlayTitle(title);
    setOverlayMessage(message);
    setOverlaySubMessage(
      subMessage ?? "Sluit deze pagina niet af totdat de actie klaar is."
    );
    setOverlayOpen(true);
  }
  ...
  function closeOverlay() {
    ...
    setOverlayMessage("");
    setOverlaySubMessage("Sluit deze pagina niet af totdat de actie klaar is.");
  }
  ...
  async function addPartijSubmit() {
    ...
    openOverlay(
      "Partij toevoegen",
      "Nieuwe partij wordt toegevoegd...",
      "Even wachten tot de partij is opgeslagen."
    );
  ...
  async function deletePartij(partijNr: number, boutId?: string | null) {
    ...
    openOverlay(
      "Verwijderen",
      `Partij ${partijNr} wordt verwijderd...`,
      "Even wachten tot verwijderen klaar is."
    );
  ...
  async function stuurDoorNaarOfficials() {
    ...
    openOverlay(
      "Doorsturen",
      "Matchmaking wordt doorgestuurd naar bond...",
      "Even wachten tot doorsturen klaar is."
    );
    ...
    try {
      ...
      setOverlayMessage("Status wordt bijgewerkt...");
  ...
  async function stuurNaarUitslagen() {
    ...
    openOverlay(
      "Doorsturen",
      "Matchmaking wordt doorgestuurd naar uitslagen...",
      "Even wachten tot doorsturen klaar is."
    );
            ...
            >
              ...
              >
                ...
                <div className="flex flex-1 items-center justify-end gap-3 flex-wrap">
                  ...
                  />
                  <DarkActionButton
                    label={releaseBusy ? "Sturen…" : "→ Naar uitslagen"}
                    tone="purple"
