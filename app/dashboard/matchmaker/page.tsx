          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                <NvbDarkButton
                  label="MM upload voor controle"
                  onClick={() =>
                    router.push("/dashboard/matchmaker/upload")
                  }
                />

                <NvbDarkButton
                  label="Controle upload overzicht"
                  onClick={() =>
                ...
                <NvbDarkButton
                  label="Upload inschrijvingen"
                  onClick={() =>
                    router.push("/dashboard/matchmaker/inschrijvingen/upload")
                  }
                />

                <NvbDarkButton
                  label="Beheer inschrijvingen"
                  onClick={() =>
                    router.push("/dashboard/matchmaker/inschrijvingen/uploadoverzicht")
                  }
                />
                 ...
                 <NvbDarkButton
                  label="Matchmaking"
                  onClick={() =>
                    router.push("/dashboard/matchmaker/inschrijvingen/[matchmakerMatchmakingId]")
                  }
                />
              </div>
