    ...
    <Shell>
      <div className="space-y-4">
        <BruteHeaderA
          ...
          onBack={() => router.back()}
          onBackToMatchmaking={() => router.push(`/dashboard/admin/algemeen/archief/${matchmakingId}`)}
          navPrev={nav.prev ?? null}
          navNext={nav.next ?? null}
          onPrev={() =>
            nav.prev &&
            router.push(`/dashboard/admin/algemeen/archief/${matchmakingId}/partij/${nav.prev}`)
          }
          onNext={() =>
            nav.next &&
            router.push(`/dashboard/admin/algemeen/archief/${matchmakingId}/partij/${nav.next}`)
          }
        />
