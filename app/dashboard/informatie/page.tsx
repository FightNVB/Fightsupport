...
type MenuAction = {
  ...
  external?: string;
  icon: LucideIcon;
  category: "Reglement" | "Beleid" | "Aanvraag" | "Toets";
};
...
export default function InformatiePage() {
  ...
  const actions: MenuAction[] = [
    {
      title: "NVB Wedstrijdreglement",
      description: "Open het actuele wedstrijdreglement met de geldende regels voor wedstrijden.",
      external: "/nvb_wedstrijdreglement.pdf",
      icon: ClipboardList,
      category: "Reglement",
    },
    {
      title: "Matchmaker Reglement",
      description: "Bekijk de regels, verantwoordelijkheden en afspraken voor matchmakers.",
      external: "/nvb_matchmaker_reglement.pdf",
      icon: Users,
      category: "Reglement",
    },
    {
      title: "Promotor Beleid",
      description: "Open het beleid en de praktische afspraken die voor promotors gelden.",
    ...
    {
      title: "Kennistoets",
      description: "Start de NVB-kennistoets over het wedstrijdreglement.",
      external: "https://form.jotform.com/252374559618064",
      icon: Trophy,
      category: "Toets",
    },
    {
      title: "Sparring Evenementen",
      description: "Lees de richtlijnen en voorwaarden voor sparringsevenementen.",
    ...
    {
      title: "MMA Reglement",
      description: "Open het actuele MMA-reglement met de geldende wedstrijdregels.",
      external: "/MMA_reglement.pdf",
      icon: FileText,
      category: "Reglement",
    },
    {
      title: "Aanvraag Talentstatus",
      description: "Open de aanvraag voor talentstatus voor sporters vanaf zestien jaar.",
      external: "https://form.jotform.com/252374009578059",
      icon: Award,
      category: "Aanvraag",
    },
    {
      title: "Sanctiebeleid 2026",
      description: "Open het actuele sanctiebeleid en de bijbehorende maatregelen.",
    ...
    <main className="fs-page">
      ...
      <div className="fs-shell">
        ...
        <div className="fs-content">
          <section className="fs-status-strip" aria-label="Informatieoverzicht">
            <StatusItem icon={FileText} value="8" label="Documenten" sublabel="Regels en beleid" />
            <StatusItem icon={ClipboardList} value="3" label="Reglementen" sublabel="Direct openen" />
            <StatusItem icon={ShieldCheck} value="3" label="Beleid" sublabel="Richtlijnen" />
            <StatusItem icon={Sparkles} value="2" label="Acties" sublabel="Toets en aanvraag" />
          </section>

          <section className="fs-section">
            <SectionHeading
              title="Reglementen & Informatie"
              subtitle="Documenten, beleid, formulieren en naslag"
            />

            <div className="fs-card-grid fs-information-grid">
              {actions.map((item) => (
          ...
          <footer className="fs-footer">© FIGHTSUPPORT · REGLEMENTEN & INFORMATIE</footer>
        </div>
      </div>
    </main>
  );
...
function Sidebar({
  ...
  const items: Array<{ label: string; href: string; icon: LucideIcon; active?: boolean }> = [
    { label: "Informatie", href: "/dashboard/informatie", icon: Home, active: true },
    { label: "Reglementen", href: "/dashboard/informatie", icon: ClipboardList },
    { label: "Beleid", href: "/dashboard/informatie", icon: ShieldCheck },
  ...
  return (
    <aside className={`fs-sidebar${open ? " fs-sidebar-open" : ""}`}>
      <button
        ...
        onClick={() => onNavigate("/dashboard/informatie")}
        aria-label="FightSupport informatie"
      >
      ...
      <nav className="fs-sidebar-nav" aria-label="Informatie navigatie">
        {items.map((item) => (
          <button
            type="button"
            key={item.label}
    ...
    <header className="fs-header">
      ...
      <div className="fs-title-band">
        <div className="fs-title-center">
          <h1>Reglementen & Informatie</h1>
          <p>Reglementen, documenten en naslag</p>
        </div>
      ...
      dangerouslySetInnerHTML={{
        ...
        * { box-sizing: border-box; }
        ...
        .fs-category-badge {
          ...
          right: 10px;
          padding: 3px 7px;
          border: 1px solid rgba(225,228,232,.34);
          background: linear-gradient(180deg, #24292f, #0b0d10);
          color: #cdd1d6;
          font-size: 8px;
          font-weight: 900;
          letter-spacing: .8px;
