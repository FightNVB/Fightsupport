...
function Panel({ children }: { children: ReactNode }) {
  return (
    <main className="min-h-screen px-4 py-6" style={PAGE_BG}>
      <div className="mx-auto max-w-[1400px] rounded-[34px] p-[7px]" style={OUTER_SHELL}>
...
function PortalCard({
  ...
  return (
    <div className="rounded-[24px] p-5" style={CARD_BG}>
      ...
      <button
        type="button"
        onClick={onClick}
        className="rounded-[12px] px-5 py-2.5 text-sm font-extrabold text-white transition hover:brightness-105"
        style={{
...
export default function PromotorDashboardPage() {
  ...
  return (
    <Panel>
      <div className="px-6 py-5" style={HEADER_BG}>
