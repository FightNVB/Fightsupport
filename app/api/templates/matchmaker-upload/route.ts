...
export async function GET() {
  ...
  ws.columns = [
    ...
    { header: "titel_partij", key: "titel_partij", width: 12 }, // Ja/Nee
    { header: "toernooi", key: "toernooi", width: 10 },         // Ja/Nee
  ];
  ...
  ws.addRow({
    ...
    klasse: "JEUGD KLASSE",
    naam_rood: "Jair Ronodimedjo",
    gym_rood: "Gym Zero50 / ZeroFifty Fights",
    va_rood: "20483",
    kg_rood: 50.0,
    naam_blauw: "Keyon Huizing",
    gym_blauw: "Fight Club Meppel",
    va_blauw: "15592",
    kg_blauw: 50.0,
    titel_partij: "Nee",
    toernooi: "Nee",
  ...
  info.addRow({
    info:
      "UPLOAD TEMPLATE (MATCHMAKER). Laat de kolomnamen exact staan. titel_partij/toernooi invullen met Ja of Nee.",
  });
  ...
  return new NextResponse(Buffer.from(buf), {
    headers: {
      ...
      "Content-Disposition": 'attachment; filename="matchmaker_upload_template.xlsx"',
    },
  });
}