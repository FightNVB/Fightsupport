// app/api/control-engine/approve-gala-duur/route.ts
...
export async function POST(req: Request) {
  try {
    ...
    const row: any = {
      ...
      partij_nr: null,
      resultaat: "ok",
      rule: "Gala duur goedgekeurd",
      rule_code: "GALA_DUUR_GOEDGEKEURD",
      boodschap: "Toestemming gegeven (official/hoofdofficial/admin/superadmin).",
    };
    ...
    console.error("approve-gala-duur error:", e);
