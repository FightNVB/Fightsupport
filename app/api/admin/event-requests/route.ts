...
export async function GET(req: Request) {
  try {
    ...
    const { data, error } = await supabase
      .from("event_requests")
      .select("id, created_at, naam, datum, locatie, bondteam, disciplines, promotor_name, promotor_email, voorkeur_hoofdofficial_name, toegewezen_hoofdofficial_name, status")
