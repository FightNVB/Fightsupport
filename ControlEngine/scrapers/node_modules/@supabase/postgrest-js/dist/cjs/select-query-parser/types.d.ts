import type { GenericRelationship, GenericSchema, GenericTable, ClientServerOptions, GenericSetofOption, GenericFunction } from '@supabase/postgrest-js/src/types/common/common';
import type { Prettify } from '@supabase/postgrest-js/src/types/types';
