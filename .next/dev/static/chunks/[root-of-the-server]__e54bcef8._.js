...
"[project]/app/dashboard/officials/controle/[matchmakingId]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ControleMatchmakingPage() {
    ...
    const [showWeegstationModal, setShowWeegstationModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    async function load() {
        ...
        try {
            ...
            const { data: lastCtxRows, error: lastErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("controle_bout_context").select("controle_run_id, created_at").eq("matchmaking_id", matchmakingId).order("created_at", {
                ascending: false
            }).limit(1);
            ...
            let ctxQuery = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("controle_bout_context").select("*").eq("matchmaking_id", matchmakingId);
            ...
            const { data: resRows, error: resErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("controle_resultaten").select("partij_nr, bout_id, hoek, resultaat, rule, rule_code, boodschap, review_status, original_resultaat").eq("controle_run_id", latestControleRunId);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ControleMatchmakingPage.useEffect": ()=>{
            load();
    ...
    const rowsByPartijNr = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ControleMatchmakingPage.useMemo[rowsByPartijNr]": ()=>{
            return [
                ...
                "ControleMatchmakingPage.useMemo[rowsByPartijNr]": (a, b)=>Number(a.partij_nr ?? 0) - Number(b.partij_nr ?? 0)
            }["ControleMatchmakingPage.useMemo[rowsByPartijNr]"]);
        }
    }["ControleMatchmakingPage.useMemo[rowsByPartijNr]"], [
        rows
    ...
    const filteredRows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ControleMatchmakingPage.useMemo[filteredRows]": ()=>{
            ...
            }["ControleMatchmakingPage.useMemo[filteredRows].base"]);
            if (!q) return base;
            const hay = {
            ...
            return base.filter({
                "ControleMatchmakingPage.useMemo[filteredRows]": (r)=>hay(r).includes(q)
            }["ControleMatchmakingPage.useMemo[filteredRows]"]);
        }
    }["ControleMatchmakingPage.useMemo[filteredRows]"], [
        rowsByPartijNr,
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    showWeegstationModal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ControleMatchmakingPage, "aaJ7G+BG9me73cWLdQwfdFI5MH0=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e54bcef8._.js.map