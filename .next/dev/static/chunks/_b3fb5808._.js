...
"[project]/app/dashboard/dispensatie/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DispensatiePage() {
    ...
    async function getUserRole() {
        try {
            const { data: auth } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
            const uid = auth?.user?.id ?? null;
            if (!uid) return setMyRole(null);
            const { data: ur } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("user_roles").select("role_id").eq("user_id", uid);
            const roleIds = (ur ?? []).map((r)=>Number(r.role_id)).filter(Number.isFinite);
            if (roleIds.length === 0) return setMyRole(null);
            const { data: roles } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("roles").select("id,name").in("id", roleIds);
    ...
    const counts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DispensatiePage.useMemo[counts]": ()=>{
            const c = {
                nieuw: 0,
                open: 0,
                pending: 0,
...
_s(DispensatiePage, "bvYhYVxwrNbijXpcgfqKk2dC678=", false, function() {
    return [
...
__turbopack_context__.k.register(_c1, "DispensatiePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_b3fb5808._.js.map