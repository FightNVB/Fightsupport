...
"[project]/lib/weegstation/weighInRulesEngine.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/dashboard/officials/weegstation/[matchmakingId]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$weegstation$2f$weighInRulesEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/weegstation/weighInRulesEngine.ts [app-client] (ecmascript)");
;
...
function getLiveEval(row, draft) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$weegstation$2f$weighInRulesEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["evaluateWeighInBout"])({
...
function WeegstationDetailPage() {
    ...
    const activeInputRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const [finalizing, setFinalizing] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [myBondteam, setMyBondteam] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const isHoofdofficialOrSuperadmin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WeegstationDetailPage.useMemo[isHoofdofficialOrSuperadmin]": ()=>roleNames.includes("hoofdofficial") || roleNames.includes("superadmin")
    }["WeegstationDetailPage.useMemo[isHoofdofficialOrSuperadmin]"], [
        roleNames
    ]);
    // Matchmakers can view weegstation read-only but cannot edit weights, penalties or dispensaties
    const isMatchmakerOnly = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WeegstationDetailPage.useMemo[isMatchmakerOnly]": ()=>roleNames.includes("matchmaker") && !roleNames.some({
                "WeegstationDetailPage.useMemo[isMatchmakerOnly]": (r)=>[
                        "official",
                        "hoofdofficial",
                        "admin",
                        "superadmin",
            ...
            }["WeegstationDetailPage.useMemo[isMatchmakerOnly]"])
    }["WeegstationDetailPage.useMemo[isMatchmakerOnly]"], [
        roleNames
    ]);
    const canAccess = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WeegstationDetailPage.useMemo[canAccess]": ()=>roleNames.some({
                "WeegstationDetailPage.useMemo[canAccess]": (r)=>[
                        "official",
                        "hoofdofficial",
                        "admin",
                        "superadmin",
            ...
            }["WeegstationDetailPage.useMemo[canAccess]"])
    }["WeegstationDetailPage.useMemo[canAccess]"], [
        roleNames
    ]);
    ...
    async function fetchRows(mmId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("weigh_in_bouts").select("*").eq("matchmaking_id", mmId).order("partij_nr", {
            ascending: true
        });
    ...
    async function refreshRows(manual = false) {
        ...
        setNotice(null);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$authedFetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authedFetch"])("/api/officials/weegstation/build", {
                method: "POST",
                headers: {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WeegstationDetailPage.useEffect": ()=>{
            async function load() {
                setLoading(true);
                setError(null);
                setNotice(null);
                try {
                    const { data: authData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
                    const uid = authData?.user?.id;
                    if (!uid) {
                        router.push("/login");
                        return;
                    }
                    const { data: profile, error: profileErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("user_profiles").select("id, bondteam").eq("id", uid).single();
                    if (profileErr) throw profileErr;
                    setMyBondteam(String(profile?.bondteam ?? "").trim());
                    const { data: userRoles, error: urErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("user_roles").select("role_id").eq("user_id", uid);
                    if (urErr) throw urErr;
                    const roleIds = (userRoles ?? []).map({
                        "WeegstationDetailPage.useEffect.load.roleIds": (r)=>r.role_id
                    }["WeegstationDetailPage.useEffect.load.roleIds"]).filter(Boolean);
                    let names = [];
                    if (roleIds.length > 0) {
                        const { data: rolesRows, error: rolesErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("roles").select("id, name").in("id", roleIds);
                        if (rolesErr) throw rolesErr;
                        names = (rolesRows ?? []).map({
                            "WeegstationDetailPage.useEffect.load": (r)=>normalizeRoleName(r?.name)
                        }["WeegstationDetailPage.useEffect.load"]).filter(Boolean);
                    }
                    setRoleNames(names);
                    if (!names.some({
                        "WeegstationDetailPage.useEffect.load": (r)=>[
                                "official",
                                "hoofdofficial",
                                "admin",
                                "superadmin",
                    ...
                    }["WeegstationDetailPage.useEffect.load"])) {
                        throw new Error("Je hebt geen toegang tot de weeglijst.");
                    }
                    const { data: mm, error: mmErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("matchmaking_uploads").select("matchmaking_id, bondteam, evenement_naam, evenement_datum, locatie").eq("matchmaking_id", matchmakingId).single();
                    if (mmErr) throw mmErr;
                    setHeader(mm);
                    const mmBondteam = String(mm?.bondteam ?? "").trim().toLowerCase();
                    const adminAccess = names.some({
                        "WeegstationDetailPage.useEffect.load.adminAccess": (r)=>[
                                "admin",
                                "superadmin",
                                "dispensatie_admin"
                            ].includes(r)
                    }["WeegstationDetailPage.useEffect.load.adminAccess"]);
                    const teamAccess = names.some({
                        "WeegstationDetailPage.useEffect.load": (r)=>r === "official" || r === "hoofdofficial"
                    }["WeegstationDetailPage.useEffect.load"]) && mmBondteam && mmBondteam === String(profile?.bondteam ?? "").trim().toLowerCase();
    ...
    const fighterResults = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WeegstationDetailPage.useMemo[fighterResults]": ()=>{
            const list = [];
            for (const row of rows){
    ...
    const searchSuggestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WeegstationDetailPage.useMemo[searchSuggestions]": ()=>{
            const q = search.trim();
            const sortBaseResults = {
                "WeegstationDetailPage.useMemo[searchSuggestions].sortBaseResults": (a, b)=>{
            ...
            }["WeegstationDetailPage.useMemo[searchSuggestions].sortBaseResults"];
            const base = [
                ...fighterResults
            ].sort(sortBaseResults);
            if (!q) return base.slice(0, 24);
            return base.map({
                "WeegstationDetailPage.useMemo[searchSuggestions]": (item)=>({
                        item,
                        score: scoreFighterSearch(item, q)
                    })
            }["WeegstationDetailPage.useMemo[searchSuggestions]"]).filter({
                "WeegstationDetailPage.useMemo[searchSuggestions]": (x)=>x.score > 0
            }["WeegstationDetailPage.useMemo[searchSuggestions]"]).sort({
                "WeegstationDetailPage.useMemo[searchSuggestions]": (a, b)=>{
            ...
            }["WeegstationDetailPage.useMemo[searchSuggestions]"]).slice(0, 24).map({
                "WeegstationDetailPage.useMemo[searchSuggestions]": (x)=>x.item
            }["WeegstationDetailPage.useMemo[searchSuggestions]"]);
        }
    }["WeegstationDetailPage.useMemo[searchSuggestions]"], [
        fighterResults,
    ...
    const counts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WeegstationDetailPage.useMemo[counts]": ()=>{
            let nogNiet = 0;
            let deels = 0;
            let volledig = 0;
            let dispensaties = 0;
    ...
    async function saveSelected() {
        ...
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$authedFetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authedFetch"])("/api/officials/weegstation/update", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    async function decideDispensation(rowId, decision) {
        ...
        setNotice(null);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$authedFetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authedFetch"])("/api/officials/weegstation/dispensatie", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    async function finalizeMatchmaking() {
        ...
        setNotice(null);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$authedFetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authedFetch"])("/api/officials/weegstation/finalize", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
                ...
                children: [
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        isHoofdofficialOrSuperadmin && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ActionButton, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: searchSuggestions.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            getLiveDispState(item.bout, evalResult) === "NODIG" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                            ...
                                                                            penalty === 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                            ...
                                                                            hasManualSanction(item.bout.admin_sanctie_nodig) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "min-w-0 flex-1",
                                children: !selectedFighter || !selectedRow || !selectedDraft || !selectedEval ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        selectedDispState === "VERLEEND" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        selectedDispState === "AFGEWEZEN" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        selectedDispState === "NODIG" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        isMatchmakerOnly && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "space-y-2",
                                                            children: (selectedEval?.messages ?? []).map((msg, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        selectedIsOutsideWeightClass && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        hasManualSanction(selectedRow.admin_sanctie_nodig) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        !selectedCanAssignPenalty ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            lineNumber: 1903,
                                                            columnNumber: 25
                                                        }, this) : !isHoofdofficialOrSuperadmin ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        !isMatchmakerOnly && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ActionButton, {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    dispState === "NODIG" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    ...
                                                                    hasManualSanction(row.admin_sanctie_nodig) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: "rounded-sm border border-violet-300 bg-violet-100 px-2 py-1 text-[10px] font-black text-violet-800",
                                                                        children: "Handmatig"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/app/dashboard/officials/weegstation/[matchmakingId]/page.tsx",
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    (dispState === "VERLEEND" || dispState === "AFGEWEZEN") && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(WeegstationDetailPage, "y/dQCCOGCwtdA4si7dSBNj4v0rQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c2 = WeegstationDetailPage;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "StatBox");
__turbopack_context__.k.register(_c1, "ActionButton");
__turbopack_context__.k.register(_c2, "WeegstationDetailPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_036d1447._.js.map