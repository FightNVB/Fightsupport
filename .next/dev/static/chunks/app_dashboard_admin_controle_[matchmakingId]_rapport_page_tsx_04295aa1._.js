...
function Badge({ status }) {
    ...
    if (status === "VERBOD") return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
async function getEventMeta(matchmaking_id) {
    try {
        const { data: up, error: upErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("matchmaking_uploads").select("event_id, evenement_naam, evenement_datum, matchmaking_id, bondteam").or(`id.eq.${matchmaking_id},matchmaking_id.eq.${matchmaking_id}`).order("uploaded_at", {
            ascending: false
        }).limit(1).maybeSingle();
...
function RapportPage() {
    ...
    const openMeldingen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RapportPage.useMemo[openMeldingen]": ()=>{
            const filtered = (resultaten ?? []).filter({
                "RapportPage.useMemo[openMeldingen].filtered": (r)=>{
            ...
            }["RapportPage.useMemo[openMeldingen].filtered"]);
            return dedupeRows(filtered);
        }
    }["RapportPage.useMemo[openMeldingen]"], [
        resultaten
    ]);
    const openKeurmerkRows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RapportPage.useMemo[openKeurmerkRows]": ()=>{
            return (resultaten ?? []).filter({
                "RapportPage.useMemo[openKeurmerkRows]": (r)=>isKeurmerkOpenIssue(r) && !isBelgischeManualCheckRow(r)
            }["RapportPage.useMemo[openKeurmerkRows]"]);
        }
    }["RapportPage.useMemo[openKeurmerkRows]"], [
        resultaten
    ]);
    const ctxByPartij = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RapportPage.useMemo[ctxByPartij]": ()=>{
            const map = new Map();
    ...
    const verbodStartverbodIssues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RapportPage.useMemo[verbodStartverbodIssues]": ()=>{
            const items = [];
            const seen = new Set();
            ...
            return items.sort({
                "RapportPage.useMemo[verbodStartverbodIssues]": (a, b)=>{
    ...
    const meldByPartij = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RapportPage.useMemo[meldByPartij]": ()=>{
            ...
            for (const [pn, arr] of m.entries()){
                arr.sort({
                    "RapportPage.useMemo[meldByPartij]": (a, b)=>statusPrio(statusFromResultaat(a.resultaat, a.rule_code)) - statusPrio(statusFromResultaat(b.resultaat, b.rule_code))
                }["RapportPage.useMemo[meldByPartij]"]);
                m.set(pn, arr);
            }
            return m;
    ...
    const licentieMetaByPartijHoek = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RapportPage.useMemo[licentieMetaByPartijHoek]": ()=>{
            const map = new Map();
            for (const r of resultaten ?? []){
    ...
    const partijenCompact = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RapportPage.useMemo[partijenCompact]": ()=>{
            return (ctxRows ?? []).map({
                "RapportPage.useMemo[partijenCompact]": (p)=>{
                    const pn = Number(p.partij_nr);
    ...
    const licentieIssues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RapportPage.useMemo[licentieIssues]": ()=>{
            const items = [];
            for (const p of ctxRows ?? []){
                const pn = Number(p.partij_nr);
                if (!Number.isFinite(pn)) continue;
                ...
                const add = {
                    "RapportPage.useMemo[licentieIssues].add": (hoek, naam, gym, detail)=>{
                        items.push({
                            partij_nr: pn,
                            partij,
                            hoek,
                ...
                }["RapportPage.useMemo[licentieIssues].add"];
            ...
            return items.sort({
                "RapportPage.useMemo[licentieIssues]": (a, b)=>{
                    if (a.partij_nr !== b.partij_nr) return a.partij_nr - b.partij_nr;
                    if (a.hoek !== b.hoek) return a.hoek.localeCompare(b.hoek);
                    return a.naam.localeCompare(b.naam, "nl");
                }
    ...
    const missingVaIssues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RapportPage.useMemo[missingVaIssues]": ()=>{
            const items = [];
            const missingRows = dedupeRows((resultaten ?? []).filter({
                "RapportPage.useMemo[missingVaIssues].missingRows": (r)=>{
                    if (!isMissingVARow(r)) return false;
                    if (isApprovedOrClosed(r.review_status)) return false;
                    return true;
                }
            }["RapportPage.useMemo[missingVaIssues].missingRows"]));
            ...
            return items.sort({
                "RapportPage.useMemo[missingVaIssues]": (a, b)=>{
                    if (a.partij_nr !== b.partij_nr) return a.partij_nr - b.partij_nr;
                    if (a.hoek !== b.hoek) return a.hoek.localeCompare(b.hoek);
                    return a.naam.localeCompare(b.naam, "nl");
                }
    ...
    const keurmerkIssues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RapportPage.useMemo[keurmerkIssues]": ()=>{
            const items = [];
            const seen = new Set();
            ...
            return items.sort({
                "RapportPage.useMemo[keurmerkIssues]": (a, b)=>{
                    if (a.partij_nr !== b.partij_nr) return a.partij_nr - b.partij_nr;
                    if (a.hoek !== b.hoek) return a.hoek.localeCompare(b.hoek);
                    return a.naam.localeCompare(b.naam, "nl");
                }
    ...
    const fightpaspoortGewijzigd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RapportPage.useMemo[fightpaspoortGewijzigd]": ()=>{
            const items = [];
            const seen = new Set();
            for (const p of ctxRows ?? []){
                const pn = Number(p.partij_nr);
            ...
            return items.sort({
                "RapportPage.useMemo[fightpaspoortGewijzigd]": (a, b)=>{
                    if (a.partij_nr !== b.partij_nr) return a.partij_nr - b.partij_nr;
    ...
    const sportschoolIssues = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RapportPage.useMemo[sportschoolIssues]": ()=>{
            ...
            return {
                belgischeCheck: Array.from(belgischeCheck).sort({
                    "RapportPage.useMemo[sportschoolIssues]": (a, b)=>a.localeCompare(b, "nl")
                }["RapportPage.useMemo[sportschoolIssues]"]),
                nietGevonden: Array.from(nietGevonden).sort({
                    "RapportPage.useMemo[sportschoolIssues]": (a, b)=>a.localeCompare(b, "nl")
                }["RapportPage.useMemo[sportschoolIssues]"]),
                geenKeurmerk: Array.from(geenKeurmerk).sort({
                    "RapportPage.useMemo[sportschoolIssues]": (a, b)=>a.localeCompare(b, "nl")
                }["RapportPage.useMemo[sportschoolIssues]"]),
                geenData: Array.from(geenData).sort({
                    "RapportPage.useMemo[sportschoolIssues]": (a, b)=>a.localeCompare(b, "nl")
                }["RapportPage.useMemo[sportschoolIssues]"]),
                verlopen: Array.from(verlopen).sort({
                    "RapportPage.useMemo[sportschoolIssues]": (a, b)=>a.localeCompare(b, "nl")
                }["RapportPage.useMemo[sportschoolIssues]"]),
                datumOntbreekt: Array.from(datumOntbreekt).sort({
                    "RapportPage.useMemo[sportschoolIssues]": (a, b)=>a.localeCompare(b, "nl")
                }["RapportPage.useMemo[sportschoolIssues]"])
            };
        }
    ...
    const partijMetOpenMeldingen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "RapportPage.useMemo[partijMetOpenMeldingen]": ()=>{
            return (ctxRows ?? []).map({
                "RapportPage.useMemo[partijMetOpenMeldingen]": (p)=>{
                    const pn = Number(p.partij_nr);
            ...
            }["RapportPage.useMemo[partijMetOpenMeldingen]"]).filter(Boolean);
        }
    }["RapportPage.useMemo[partijMetOpenMeldingen]"], [
        ctxRows,
        meldByPartij
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FsLogo, {}, void 0, false, {
                                        fileName: "[project]/app/dashboard/admin/controle/[matchmakingId]/rapport/page.tsx",
                                        lineNumber: 1399,
                                        columnNumber: 15
                                    }, this)
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        children: [
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                            className: "jsx-ff900f9018a9c936",
                                                            children: verbodStartverbodIssues.length ? verbodStartverbodIssues.map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                                    className: "jsx-ff900f9018a9c936",
                                                                    children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                            className: "jsx-ff900f9018a9c936",
                                                            children: licentieIssues.length ? licentieIssues.map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                                    className: "jsx-ff900f9018a9c936",
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                            className: "jsx-ff900f9018a9c936" + " " + `rounded-l-md px-2 py-1.5 font-bold ${rowBg(idx)}`,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                            className: "jsx-ff900f9018a9c936",
                                                            children: missingVaIssues.length ? missingVaIssues.map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                                    className: "jsx-ff900f9018a9c936",
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                            className: "jsx-ff900f9018a9c936" + " " + `rounded-l-md px-2 py-1.5 font-bold ${rowBg(idx)}`,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                            className: "jsx-ff900f9018a9c936",
                                                            children: fightpaspoortGewijzigd.length ? fightpaspoortGewijzigd.map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                                    className: "jsx-ff900f9018a9c936",
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                            className: "jsx-ff900f9018a9c936" + " " + `rounded-l-md px-2 py-1.5 font-bold ${rowBg(idx)}`,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                            className: "jsx-ff900f9018a9c936",
                                                            children: sportschoolIssues.belgischeCheck.length ? sportschoolIssues.belgischeCheck.map((gym, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                                    className: "jsx-ff900f9018a9c936",
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                            className: "jsx-ff900f9018a9c936" + " " + `rounded-l-md px-2 py-1.5 font-bold ${rowBg(idx)}`,
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                                    ...
                                                                    children: sportschoolIssues.nietGevonden.length === 0 && sportschoolIssues.geenKeurmerk.length === 0 && sportschoolIssues.geenData.length === 0 && sportschoolIssues.verlopen.length === 0 && sportschoolIssues.datumOntbreekt.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                                        ...
                                                                        children: [
                                                                            sportschoolIssues.nietGevonden.map((gym, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                                                    className: "jsx-ff900f9018a9c936",
                                                                                    children: [
                                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                                            className: "jsx-ff900f9018a9c936" + " " + `rounded-l-md px-2 py-1.5 font-bold ${rowBg(idx)}`,
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                                            className: "jsx-ff900f9018a9c936",
                                                                            children: keurmerkIssues.length ? keurmerkIssues.map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                                                    className: "jsx-ff900f9018a9c936",
                                                                                    children: [
                                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                                            className: "jsx-ff900f9018a9c936" + " " + `rounded-l-md px-2 py-1.5 font-bold ${rowBg(idx)}`,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: partijMetOpenMeldingen.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                                                                            ...
                                                                            children: [
                                                                                ...
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                                    ...
                                                                                    children: [
                                                                                        ...
                                                                                        m.aantekeningen ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                    className: "jsx-ff900f9018a9c936",
                                                    children: partijenCompact.map((p, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                            className: "jsx-ff900f9018a9c936",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
...
_s1(RapportPage, "0Jqn7YRae4qr/PEIXR6JCoRIxrM=", false, function() {
    return [
...
__turbopack_context__.k.register(_c2, "FsLogo");
__turbopack_context__.k.register(_c3, "RapportPage");
...
//# sourceMappingURL=app_dashboard_admin_controle_%5BmatchmakingId%5D_rapport_page_tsx_04295aa1._.js.map