...
"[project]/app/dashboard/matchmaker/matchmaking/[matchmakingId]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StatusBadge({ status }) {
    if (status === "afgekeurd") return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Chip, {
        label: "AFKEUR",
        tone: "red"
    }, void 0, false, {
        fileName: "[project]/app/dashboard/matchmaker/matchmaking/[matchmakingId]/page.tsx",
...
function MatchmakerMatchmakingPage() {
    ...
    const [reloadTick, setReloadTick] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const [statusByPartij, setStatusByPartij] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [runMeldingen, setRunMeldingen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [fDiscipline, setFDiscipline] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [fKlasse, setFKlasse] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [fRoodNaam, setFRoodNaam] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [fRoodGym, setFRoodGym] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [fRoodVa, setFRoodVa] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [fRoodKg, setFRoodKg] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [fBlauwNaam, setFBlauwNaam] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [fBlauwGym, setFBlauwGym] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const subtitle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MatchmakerMatchmakingPage.useMemo[subtitle]": ()=>{
    ...
    const separator = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MatchmakerMatchmakingPage.useMemo[separator]": ()=>({
                height: "1px",
    ...
    async function addPartijSubmit() {
        ...
        try {
            ...
            const resp = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$authedFetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authedFetch"])("/api/matchmaking/add-bout", {
                method: "POST",
                headers: {
    ...
    async function deletePartij(partijNr, boutId) {
        ...
        try {
            const token = await getAccessToken();
            if (!token) throw new Error("Niet ingelogd.");
            const resp = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$authedFetch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authedFetch"])("/api/matchmaking/delete-partij", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`
    ...
    async function load() {
        ...
        try {
            ...
            const { data: lastCtxRows, error: lastErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("matchmaker_fighter_context").select("controle_run_id, created_at").eq("matchmaking_id", matchmakingId).order("created_at", {
                ascending: false
            }).limit(1);
            ...
            let ctxQuery = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("matchmaker_matches").select("*").eq("matchmaking_id", matchmakingId);
            ...
            const { data: resRows, error: resErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("matchmaker_controle_resultaten").select("partij_nr, bout_id, hoek, resultaat, rule, rule_code, boodschap").eq("controle_run_id", latestControleRunId);
            ...
            try {
                const { data: dispReq } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("dispensatie_requests").select("partij_nr").eq("matchmaking_id", matchmakingId);
                const m = {};
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MatchmakerMatchmakingPage.useEffect": ()=>{
            load();
    ...
    const galaDuur = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MatchmakerMatchmakingPage.useMemo[galaDuur]": ()=>buildGalaDuurSamenvatting(runMeldingen)
    }["MatchmakerMatchmakingPage.useMemo[galaDuur]"], [
        runMeldingen
    ]);
    const compactRunMeldingen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MatchmakerMatchmakingPage.useMemo[compactRunMeldingen]": ()=>buildCompactRunMeldingen(runMeldingen)
    }["MatchmakerMatchmakingPage.useMemo[compactRunMeldingen]"], [
        runMeldingen
    ]);
    const rowsByPartijNr = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MatchmakerMatchmakingPage.useMemo[rowsByPartijNr]": ()=>{
            return [
                ...rows
            ].sort({
                "MatchmakerMatchmakingPage.useMemo[rowsByPartijNr]": (a, b)=>Number(a.partij_nr ?? 0) - Number(b.partij_nr ?? 0)
            }["MatchmakerMatchmakingPage.useMemo[rowsByPartijNr]"]);
        }
    }["MatchmakerMatchmakingPage.useMemo[rowsByPartijNr]"], [
        rows
    ]);
    const missingLicentieByPartij = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MatchmakerMatchmakingPage.useMemo[missingLicentieByPartij]": ()=>{
            const m = {};
            for (const r of rows){
                const pn = Number(r.partij_nr);
                if (!Number.isFinite(pn)) continue;
    ...
    const anyDispensatieByPartij = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MatchmakerMatchmakingPage.useMemo[anyDispensatieByPartij]": ()=>{
            const m = {};
            for (const r of rows){
                const pn = Number(r.partij_nr);
                if (!Number.isFinite(pn)) continue;
    ...
    const totals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MatchmakerMatchmakingPage.useMemo[totals]": ()=>{
    ...
    const filterCounts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MatchmakerMatchmakingPage.useMemo[filterCounts]": ()=>{
    ...
    const filteredRows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MatchmakerMatchmakingPage.useMemo[filteredRows]": ()=>{
            const q = search.trim().toLowerCase();
            const base = rowsByPartijNr.filter({
                "MatchmakerMatchmakingPage.useMemo[filteredRows].base": (r)=>{
                    const pn = Number(r.partij_nr);
            ...
            }["MatchmakerMatchmakingPage.useMemo[filteredRows].base"]);
            if (!q) return base;
            const hay = {
                "MatchmakerMatchmakingPage.useMemo[filteredRows].hay": (r)=>{
                    const parts = [
                        r.rood_naam_fp,
                        r.rood_naam_mm,
                        r.rood_naam,
                        ...
                        "MatchmakerMatchmakingPage.useMemo[filteredRows].hay.parts": (v)=>String(v ?? "").trim().toLowerCase()
                    }["MatchmakerMatchmakingPage.useMemo[filteredRows].hay.parts"]).filter(Boolean);
                    return parts.join(" ");
                }
            }["MatchmakerMatchmakingPage.useMemo[filteredRows].hay"];
            return base.filter({
                "MatchmakerMatchmakingPage.useMemo[filteredRows]": (r)=>hay(r).includes(q)
            }["MatchmakerMatchmakingPage.useMemo[filteredRows]"]);
        }
    }["MatchmakerMatchmakingPage.useMemo[filteredRows]"], [
        rowsByPartijNr,
...
_s(MatchmakerMatchmakingPage, "V3YbhSIJqMB6dqg8lSVPfbCi5+o=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c6 = MatchmakerMatchmakingPage;
...
__turbopack_context__.k.register(_c6, "MatchmakerMatchmakingPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6cfb48f8._.js.map