...
"[project]/app/dashboard/admin/controle/[matchmakingId]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ControleMatchmakingPage() {
    ...
    async function load() {
        ...
        try {
            ...
            const { data: resRows, error: resErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("controle_resultaten").select("partij_nr, bout_id, hoek, resultaat, rule, rule_code, boodschap").eq("controle_run_id", latestControleRunId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ee7ae3e5._.js.map