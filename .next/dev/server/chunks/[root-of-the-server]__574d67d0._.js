...
async function POST(req) {
    try {
        ...
        if (!matchmaking_id) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "matchmaking_id ontbreekt"
        }, {
            status: 400
        });
        if (!Number.isFinite(partij_nr)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const { data: existingBout, error: exErr } = await supabase.from("matchmaking_bouts_raw").select("va_rood, va_blauw, rood_va_mm_prev, blauw_va_mm_prev").eq("matchmaking_id", matchmaking_id).eq("partij_nr", partij_nr).maybeSingle();
        if (exErr) {
            console.error("Kon bestaande bout niet ophalen:", exErr);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: exErr.message ?? "Kon bestaande bout niet ophalen"
            }, {
                status: 500
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__574d67d0._.js.map