...
"[project]/app/api/officials/weegstation/update/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const { admin, userId, isHoofdofficialLike } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$weegstation$2f$routeAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getWeegstationAuthContext"])(req);
        ...
        const nextRood = toNum(body?.rood_gewogen_gewicht);
        const nextBlauw = toNum(body?.blauw_gewogen_gewicht);
        const note = String(body?.weging_notitie ?? "").trim();
        const requestedStrafpuntRood = toPenalty(body?.gewicht_strafpunt_rood);
        const requestedStrafpuntBlauw = toPenalty(body?.gewicht_strafpunt_blauw);
        ...
        const finalStrafpuntRood = isHoofdofficialLike && evalResult.canProceedWithPenalty && evalResult.nietOpGewichtRood ? requestedStrafpuntRood : 0;
        const finalStrafpuntBlauw = isHoofdofficialLike && evalResult.canProceedWithPenalty && evalResult.nietOpGewichtBlauw ? requestedStrafpuntBlauw : 0;
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            bout: updated,
            eval: evalResult,
            hoofdofficial_required_for_penalty: !isHoofdofficialLike && evalResult.canProceedWithPenalty && (requestedStrafpuntRood && evalResult.nietOpGewichtRood || requestedStrafpuntBlauw && evalResult.nietOpGewichtBlauw)
        });
    } catch (e) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__73655570._.js.map