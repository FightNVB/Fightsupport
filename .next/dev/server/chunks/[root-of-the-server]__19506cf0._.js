...
async function POST(req) {
    try {
        ...
        if (runIds.length) {
            const { error: resErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("controle_resultaten").delete().in("controle_run_id", runIds);
            if (resErr) throw resErr;
            const { error: ctxErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("controle_bout_context").delete().in("controle_run_id", runIds);
            if (ctxErr) throw ctxErr;
            // uitslagen_raw is snapshot per run
            const { error: uErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("uitslagen_raw").delete().in("controle_run_id", runIds);
            if (uErr) throw uErr;
        }
        // 3) runs weg
        {
